// main.js (UPDATED with Photo Fix)
...
            reader.onload = (e) => {
                // *** CRITICAL FIX: Resolve with ONLY the Base64 string part ***
                // This ensures that routes.py receives an array of strings, not objects.
                // The string starts with 'data:image/...' which is expected by the Python saving logic.
...
            photos: photos // 'photos' is now an array of Base64 strings (including the data URI header)
        };
